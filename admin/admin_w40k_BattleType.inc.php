<?php
$adminlogin = (User::hasPrivilege('admin') || User::hasPrivilege('w40kadmin') || User::hasPrivilege('battletypeadmin'));
if (empty($adminlogin))
	die("DENIED");
...
<?php if (!isset($_REQUEST['id']))
	{ ?>
		<a href="index.php?admin&w40k&type=<?php print $_REQUEST['type'] ?>&id=">Neuen BattleType anlegen</a>
	...
	?>
			<tr>
				...
				<td width="20%">
					<a href="?admin&w40k&type=<?php print $_REQUEST['type'] ?>&id=<?php print $item['id'] ?>">
