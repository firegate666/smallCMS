<?php
$adminlogin = (User::hasPrivilege('admin') || User::hasPrivilege('w40kadmin') || User::hasPrivilege('codexadmin'));
if (empty($adminlogin))
	die("DENIED");
...
<?php print $optionlist ?>
	...
	<a href="index.php?admin&w40k&type=<?php print $_REQUEST['type'] ?>&id=&gamesystem=<?php print $_REQUEST['gamesystem'] ?>">Neuen Codex anlegen</a>
	</form>
...
?>
			<tr>
				...
				<td width="20%">
					<a href='?admin&w40k&type=<?php print $_REQUEST['type'] ?>&id=<?php print $item['id'] ?>&gamesystem=<?php print $_REQUEST['gamesystem'] ?>'>
							<img src='img/edit.gif' border='0' alt='Edit'/>
						</a>
						<a href="?admin&w40k&type=<?php print $_REQUEST['type'] ?>&id=<?php print $item['id'] ?>&delete&gamesystem=<?php print $_REQUEST['gamesystem'] ?>">
